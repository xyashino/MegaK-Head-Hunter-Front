...
import { ActiveValue, FilterData, RatingData, SalaryData } from "./FilterData";
...
export type FilterActionData =
  ...
  | {
      type: FilterAction.UpdateContract;
      payload: ActiveValue<ExpectedContractTypeEnum>;
    }
  | {
      type: FilterAction.UpdateTypeWork;
  ...
  | { type: FilterAction.UpdateAll; payload: FilterData };
